...
## PRÉ-EXECUÇÃO OBRIGATÓRIA — Skill `testing-best-practices`
...
3. **Invoke a skill `testing-best-practices` ANTES de gerar** — aplique os 7 gates (Invariant First, Owning Layer, Real Execution, Failure→Fix Production, No Snapshot Without Contract, No Self-Set Mock, Negative Companion).
