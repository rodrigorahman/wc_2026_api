...
> Reference de `testing-best-practices`. Leia antes de decidir ONDE um teste deve viver.
...
Em todos esses casos, documente em `recomendacoes` (no JSON do qa-test-generator) por que o teste foi omitido.
