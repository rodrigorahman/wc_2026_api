...
> Reference de `testing-best-practices`. Aplicado em revisão de suítes existentes e ao avaliar resultado da execução do `qa-validator`.
...
## Taxonomia (use no qa-validator e ci_flakiness reports)
...
Heurística leve para qa-validator detectar flakiness emergente:
