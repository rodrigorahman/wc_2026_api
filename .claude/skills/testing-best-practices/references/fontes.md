...
> Reference de `testing-best-practices`. Bibliografia consolidada.
...
- **Performance/load testing** (k6, Gatling, Locust): coberto parcialmente pelo `qa-test-generator` em "recomendacoes" quando aplicável, mas a doutrina específica de carga ficou fora.
...
- **Acessibilidade automatizada** (axe, Pa11y): mencionada em `qa-test-generator` como categoria, mas a doutrina detalhada (WCAG rule-by-rule) ficou fora.
