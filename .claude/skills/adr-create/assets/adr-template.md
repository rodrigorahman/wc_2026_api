...
Este arquivo vive dentro da skill `adr-create` para portabilidade:
copiar `.claude/skills/adr-create/` leva o template junto. Resolvido
...
- Tags: escolher da lista canônica de tags definida na SKILL.md da
  `adr-create` (seção "Tags Canônicas"). Máximo 3 tags.
-->
---
id: NNNN
