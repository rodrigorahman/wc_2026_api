...
- Os débitos coletados refletem o estado real após a última execução de `/agent-spec-minispec-run-tasks` na `{{parent_version}}`.
...
```
/agent-spec-minispec-run-tasks docs/specs/features/{{feature}}/{{version}}/task_plan.md
```
